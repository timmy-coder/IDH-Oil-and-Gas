...
function DirectorSection() {
  return (
    <div className='flex flex-col items-center lg:flex-row lg:items-start  justify-center gap-10 mb-10'>
        <div>
        ...
        <div  className='bg-[#44749F] p-5 rounded-md text-lg w-[350px] lg:w-[600px] h-[380px] lg:text-[27px]'>
