...
function DirectorSection() {
  return (
    <div className='flex flex-col items-center lg:flex-row lg:items-start  justify-center gap-10 mb-20'>
        ...
        <div  className='bg-[#44749F] py-10 px-5 rounded-md text-lg w-[350px] lg:w-[600px] h-[380px] lg:text-[23px]'>
        ...
        <h2 className='text-2xl font-bold text-white mt-10 text-end'>Managing Director</h2>
        </div>
